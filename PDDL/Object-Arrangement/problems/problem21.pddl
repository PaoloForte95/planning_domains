(define (problem object_arrangement)
    ...
    (:objects
        ...
        pear - food
        cup - container
        wp1s wp2s wp3s wp4s wp5s wp6s wp7s wp8s wp9s wp10s wp11s wp12s wp13s wp14s wp15s wp16s wp17s wp18s wp19s wp20s - location
        wp1f wp2f wp3f wp4f wp5f wp6f wp7f wp8f wp9f wp10f wp11f wp12f wp13f wp14f wp15f wp16f wp17f wp18f wp19f wp20f - location
    ...
    (:init
        ...
        (at tape wp13s)
        (at green_cube wp14s)
        (at orange_cube wp15s)
        (at yellow_cube wp16s)
        (at black_cube wp17s)
